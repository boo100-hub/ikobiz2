"""
seed_neon.py - Seed data to Neon production database.

Run: python seed_neon.py
"""

import os
from sqlalchemy import text

# Override DATABASE_URL to use Neon production database
os.environ["DATABASE_URL"] = "postgresql+psycopg://neondb_owner:npg_L2svUA5cignT@ep-withered-flower-aqzcerq5.c-8.us-east-1.aws.neon.tech/neondb?sslmode=require"
...
prods = [
    ...
    Product(shop_id=shop6.id, title="Sports Water Bottle", description="Insulated water bottle, 1L capacity.", price=1200, stock=35, category="accessories", image_url="https://images.unsplash.com/photo-1602143407151-7111542de6e4?w=400"),
...
print(f"  - {len([admin, seller1, seller2, seller3, seller4, seller5, seller6, seller7, seller8, seller9, seller10, buyer1, buyer2, buyer3])} users (1 admin, 10 sellers, 3 buyers)")
print(f"  - {len([shop1, shop2, shop3, shop4, shop5, shop6, shop7, shop8, shop9, shop10])} shops created across different categories")
